        ...
        {project.map((/* project */) => (
          <div className="w-screen flex-shrink-0 snap-center  flex flex-col space-y-5 items-center justify-center p-20 md:p-44 h-screen">
            ...
            <div className="space-y-10 px-0 md:px-10 max-w-6xl">
              ...
              <p className="text-lg text-center md:text-left">I developed my Portfolio using Next.js, React.js, Tailwind CSS, Framer Motion, and Heroicons.
               power of Next.js, in my portfoli gives better performance giving a seamless user experience
               Reacct.js giving dynamic and interactive user experience, in other hand tailwind css facilates rapid styling and customization.
               Framer motion add fulids animation and transition, enchance the overall looks of my portfolio.
               Heroic icon give clean SVG icons, enriching the visual of the project.
              </p><br /> 
              <ol>Here are some my other projects:
              <li><a href="https://to-do-list-amber-psi.vercel.app/" className="underline">TO-DO List App</a></li>
              <li>...</li>
              <li>...</li>
              </ol>
            </div>
