    ...
    return (
        <motion.div
            ...
            <img
                ...
                src='https://logospng.org/download/tailwind-css/tailwind-css-1024.png' alt='Tailwind.Css'
            />
            <div className='absolute opacity-0 group-hover:opacity-70 transition duration-300 ease-in-out group-hover:bg-white h-24 w-24 md:w-28 md:28 xl:w-30 xl:h-30 rounded-full z-0'>
                <div className='flex items-center justify-center h-full'>
                    <p className='text-3xl text-black opacity-100'><a href="https://tailwindcss.com/">90%</a></p>
                </div>
            </div>
        </motion.div>
    )
