    ...
    return (
        <motion.div
            ...
            <img
                ...
                src='https://th.bing.com/th/id/OIP.xXhbnB60x1WQzlBG9Hi5EQHaFQ?rs=1&pid=ImgDetMain' alt='NextJs'
            />
            <div className='absolute opacity-0 group-hover:opacity-70 transition duration-300 ease-in-out group-hover:bg-white h-24 w-24 md:w-28 md:28 xl:w-30 xl:h-30 rounded-full z-0'>
                <div className='flex items-center justify-center h-full'>
                    <p className='text-3xl text-black opacity-100'><a href="https://nextjs.org/">90%</a></p>
                </div>
            </div>
        </motion.div>
    )
